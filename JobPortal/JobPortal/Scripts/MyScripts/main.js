...
function validateCompanyName(input) {
    ...
    const stateData = [
        { name: 'Punjab', cities: ['Lahore', 'Faisalabad', 'Rawalpindi', 'Multan', 'Gujranwala', 'Sialkot', 'Bahawalpur', 'Sargodha', 'Gujrat', 'Sheikhupura'] },
        { name: 'Sindh', cities: ['Karachi', 'Hyderabad', 'Sukkur', 'Larkana', 'Nawabshah', 'Mirpur Khas', 'Jacobabad', 'Shikarpur'] },
        { name: 'Khyber Pakhtunkhwa', cities: ['Peshawar', 'Mardan', 'Abbottabad', 'Mingora', 'Kohat', 'Dera Ismail Khan', 'Abbottabad', 'Mansehra'] },
        { name: 'Balochistan', cities: ['Quetta', 'Gwadar', 'Khuzdar', 'Turbat', 'Sibi', 'Hub', 'Chaman'] },
    ...
    function validateStateCity() {
        ...
        if (selectedState === 'Select a province' || selectedState === 'Select a state') {
            errorCity.textContent = 'Please select a province.';
            return false;
        } else {
